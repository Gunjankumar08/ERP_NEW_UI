  ...
  return (
    ...
    <MDBContainer fluid >
      ...
      <MDBRow> 
        ...
        <MDBCol md='6'></MDBCol>
      <MDBCol md='2'>
      <Button variant="outlined" style={{ marginLeft: "auto" }}><Link to='/add_class'>+Add Class</Link> </Button>
      </MDBCol>
      </MDBRow>
        <MDBRow>
            <MDBCol md='12'>
                  ...
                  <Table stickyHeader   aria-label="simple table" size="small">
                    <TableHead  >
                      <TableRow>
                        ...
                        <TableCell align="center"style={{fontSize:'10px',backgroundColor:'#1d1d1d',color:'white'}}><strong>Class Name</strong></TableCell>
                        <TableCell align="center"style={{fontSize:'10px',backgroundColor:'#1d1d1d',color:'white'}}><strong>Class Fee</strong></TableCell>
                    ...
                    {classData.map((row,index) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell align="center"style={{fontSize:'9px'}}>{row.class_name}</TableCell>
                          <TableCell align="center"style={{fontSize:'9px'}}>{row.class_fee}</TableCell>
                          <TableCell align="center"style={{fontSize:'9px'}}>{row.class_fee_inst}</TableCell>
                          <TableCell>
