...
import { getExtrafeeDetails } from '../../services';
...
export default function extraFeeTable() {
  const [extrafeeData,setExtrafeeData]=React.useState([]);
  useEffect(()=>{
    getExtrafeeDetails().then((response) =>
    setExtrafeeData(response.res),
  )
  ...
  return (
    ...
    <MDBContainer fluid >
      ...
      <MDBRow> 
        ...
        <MDBCol md='5'></MDBCol>
      <MDBCol md='3'>
      <Button variant="outlined" style={{ marginLeft: "auto" }}><Link to='/add_extrafee'>+Add Extra Fee</Link> </Button>
      </MDBCol>
      </MDBRow>
        <MDBRow>
            <MDBCol md='12'>
